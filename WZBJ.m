...
phi_1 = 37.195*pi/180; %rad base station

theta_1 = -80.156*pi/180; %rad
...
% 
% legend('Base Station','Blacksburg, VA', 'Christiansburg, VA', 'Pembroke, VA', 'Roanoke, VA')
% 
...
%% Individual Path Loss (that we calculate)
...
L_p_2_power = [L_p_2_power pl_n_bb];
...
L_p_5_power = [L_p_5_power pl_n_bb];
...
a  = ['Freespace Pathloss (494 MHz) for Blacksburg, VA: ', num2str(pl),' dB'];
disp(a)

pl = display_pathloss(pm, theta_c, phi_c, tx);

a  = ['Freespace Pathloss (494 MHz) for Christiansburg, VA: ', num2str(pl),' dB'];
disp(a)

pl = display_pathloss(pm, theta_pem, phi_pem, tx);

a  = ['Freespace Pathloss (494 MHz) for Pembroke, VA: ', num2str(pl),' dB'];
disp(a)

pl = display_pathloss(pm, theta_roa, phi_roa, tx);

a  = ['Freespace Pathloss (494 MHz) for Roanoke, VA: ', num2str(pl),' dB'];
disp(a)
...
a  = ['Longley-Rice Pathloss (494 MHz) for Blacksburg, VA: ', num2str(pl),' dB'];
disp(a)

L_p_longley_rice = [L_p_longley_rice pl];

pl = display_pathloss(pm, theta_c, phi_c, tx);

a  = ['Longley-Rice Pathloss (494 MHz) for Christiansburg, VA: ', num2str(pl),' dB'];
disp(a)
...
a  = ['Longley-Rice Pathloss (494 MHz) for Roanoke, VA: ', num2str(pl),' dB'];
disp(a)
...
a  = ['Longley-Rice Pathloss (494 MHz) for Pembroke, VA: ', num2str(pl),' dB'];
disp(a)
...
for counter = 1:length(L_p_longley_rice)

    L_p_longley_rice(counter) = 10^(L_p_longley_rice(counter)/10);

    L_p_2_power(counter) = 10^(L_p_2_power(counter)/10);

    L_p_5_power(counter) = 10^(L_p_5_power(counter)/10);
...
for counter = 1:length(SNR_low_pem_n_2)
    ...
    SNR_high_bb_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(1), k, bb_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_c_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(2), k, c_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_roa_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(3), k, roa_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_pem_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(4), k, pem_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_bb_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(1), k, bb_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_c_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(2), k, c_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_roa_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(3), k, roa_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_pem_n_2(counter) = input_SNR(P_T, G_R, G_T, L_p_2_power(4), k, pem_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);
...
title('SNR using Power Law Model for n=2')
...
for counter = 1:length(SNR_low_pem_n_5)
    ...
    SNR_high_bb_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(1), k, bb_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_c_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(2), k, c_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_roa_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(3), k, roa_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_pem_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(4), k, pem_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_bb_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(1), k, bb_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_c_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(2), k, c_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_roa_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(3), k, roa_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_pem_n_5(counter) = input_SNR(P_T, G_R, G_T, L_p_5_power(4), k, pem_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);
...
title('SNR using Power Law Model for n=5')
...
for counter = 1:length(SNR_low_pem_lr)
    ...
    SNR_high_bb_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(1), k, bb_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_c_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(2), k, c_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_roa_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(3), k, roa_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_high_pem_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(4), k, pem_high(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_bb_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(1), k, bb_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_c_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(2), k, c_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_roa_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(3), k, roa_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);

    SNR_low_pem_lr(counter) = input_SNR(P_T, G_R, G_T, L_p_longley_rice(4), k, pem_low(counter), T_RX, B_RX, epsilon_T, eta_T, epsilon_R, eta_R, epsilon_p, F);
...
title('SNR using Longley-Rice Model')
